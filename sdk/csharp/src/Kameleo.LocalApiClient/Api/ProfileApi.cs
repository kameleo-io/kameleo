...
namespace Kameleo.LocalApiClient.Api
{
    ...
    public interface IProfileApiSync : IApiAccessor
    {
        ...
        ProfileResponse CreateProfile(CreateProfileRequest createProfileRequest = default, int operationIndex = 0);
        ...
        ApiResponse<ProfileResponse> CreateProfileWithHttpInfo(CreateProfileRequest createProfileRequest = default, int operationIndex = 0);
        /// <summary>
        ...
        KernelResponse InstallProfileKernel(Guid profileId, int operationIndex = 0);
        ...
        ApiResponse<KernelResponse> InstallProfileKernelWithHttpInfo(Guid profileId, int operationIndex = 0);
        /// <summary>
        ...
        /// <summary>
        /// Tests the proxy connection configured on the given profile and returns every individual test step together with an overall summary. The  summary is &#39;success&#39; when every step passes, &#39;partial_success&#39; when the website could be reached through at least one of IPv4, IPv6 or DNS  name and the IP location lookup also succeeded, otherwise &#39;failure&#39;.
        /// </summary>
        /// <exception cref="Kameleo.LocalApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="profileId">The unique identifier of the profile</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TestProxyResponse</returns>
        TestProxyResponse TestProfileProxy(Guid profileId, int operationIndex = 0);
        ...
        /// <param name="profileId">The unique identifier of the profile</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TestProxyResponse</returns>
        ApiResponse<TestProxyResponse> TestProfileProxyWithHttpInfo(Guid profileId, int operationIndex = 0);
        /// <summary>
    ...
    public interface IProfileApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ProfileResponse> CreateProfileAsync(CreateProfileRequest createProfileRequest = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<ProfileResponse>> CreateProfileWithHttpInfoAsync(CreateProfileRequest createProfileRequest = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Permanently delete a profile from your workspace.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<KernelResponse> InstallProfileKernelAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<KernelResponse>> InstallProfileKernelWithHttpInfoAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Retrieve a list of all profiles loaded in your workspace. Use this endpoint to view a preview of each profile so you can quickly assess  available profiles.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TestProxyResponse</returns>
        System.Threading.Tasks.Task<TestProxyResponse> TestProfileProxyAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TestProxyResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<TestProxyResponse>> TestProfileProxyWithHttpInfoAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Update an existing profile’s settings by providing the new configuration options in the request body. Use this to modify aspects like  spoofing options or proxy settings, then receive the updated profile details.
        /// </summary>
        /// <remarks>
    ...
    public partial class ProfileApi : IProfileApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProfileResponse</returns>
        public ProfileResponse CreateProfile(CreateProfileRequest createProfileRequest = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProfileResponse</returns>
        public Kameleo.LocalApiClient.Client.ApiResponse<ProfileResponse> CreateProfileWithHttpInfo(CreateProfileRequest createProfileRequest = default, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProfileResponse</returns>
        public async System.Threading.Tasks.Task<ProfileResponse> CreateProfileAsync(CreateProfileRequest createProfileRequest = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProfileResponse)</returns>
        public async System.Threading.Tasks.Task<Kameleo.LocalApiClient.Client.ApiResponse<ProfileResponse>> CreateProfileWithHttpInfoAsync(CreateProfileRequest createProfileRequest = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>KernelResponse</returns>
        public KernelResponse InstallProfileKernel(Guid profileId, int operationIndex = 0)
        {
            Kameleo.LocalApiClient.Client.ApiResponse<KernelResponse> localVarResponse = InstallProfileKernelWithHttpInfo(profileId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of KernelResponse</returns>
        public Kameleo.LocalApiClient.Client.ApiResponse<KernelResponse> InstallProfileKernelWithHttpInfo(Guid profileId, int operationIndex = 0)
        {
            Kameleo.LocalApiClient.Client.RequestOptions localVarRequestOptions = new Kameleo.LocalApiClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "ProfileApi.InstallProfileKernel";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<KernelResponse>("/profiles/{profileId}/kernel-install", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("InstallProfileKernel", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of KernelResponse</returns>
        public async System.Threading.Tasks.Task<KernelResponse> InstallProfileKernelAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Kameleo.LocalApiClient.Client.ApiResponse<KernelResponse> localVarResponse = await InstallProfileKernelWithHttpInfoAsync(profileId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (KernelResponse)</returns>
        public async System.Threading.Tasks.Task<Kameleo.LocalApiClient.Client.ApiResponse<KernelResponse>> InstallProfileKernelWithHttpInfoAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<KernelResponse>("/profiles/{profileId}/kernel-install", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TestProxyResponse</returns>
        public TestProxyResponse TestProfileProxy(Guid profileId, int operationIndex = 0)
        {
            Kameleo.LocalApiClient.Client.ApiResponse<TestProxyResponse> localVarResponse = TestProfileProxyWithHttpInfo(profileId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TestProxyResponse</returns>
        public Kameleo.LocalApiClient.Client.ApiResponse<TestProxyResponse> TestProfileProxyWithHttpInfo(Guid profileId, int operationIndex = 0)
        {
            Kameleo.LocalApiClient.Client.RequestOptions localVarRequestOptions = new Kameleo.LocalApiClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "ProfileApi.TestProfileProxy";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<TestProxyResponse>("/profiles/{profileId}/test-proxy", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("TestProfileProxy", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TestProxyResponse</returns>
        public async System.Threading.Tasks.Task<TestProxyResponse> TestProfileProxyAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Kameleo.LocalApiClient.Client.ApiResponse<TestProxyResponse> localVarResponse = await TestProfileProxyWithHttpInfoAsync(profileId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TestProxyResponse)</returns>
        public async System.Threading.Tasks.Task<Kameleo.LocalApiClient.Client.ApiResponse<TestProxyResponse>> TestProfileProxyWithHttpInfoAsync(Guid profileId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<TestProxyResponse>("/profiles/{profileId}/test-proxy", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
