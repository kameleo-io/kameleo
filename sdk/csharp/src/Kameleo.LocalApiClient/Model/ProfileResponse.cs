...
namespace Kameleo.LocalApiClient.Model
{
    ...
    public partial class ProfileResponse : IValidatableObject
    {
        ...
        /// <param name="deviceMemory">Sets the level of device memory spoofing. Values can be &#39;automatic&#39;, &#39;manual&#39;, &#39;off&#39;.  When value is set to manual, a specific amount of device memory must be provided (valid values: 0.25, 0.5, 1, 2, 4, 8, 16, 32) (required).</param>
        /// <param name="language">A language or a comma-separated list of languages for the profile.  ISO 639-1 language and optionally ISO 3166-1 region code. (required).</param>
        ...
        */
        ...
        /// <summary>
        /// Sets the level of device memory spoofing. Values can be &#39;automatic&#39;, &#39;manual&#39;, &#39;off&#39;.  When value is set to manual, a specific amount of device memory must be provided (valid values: 0.25, 0.5, 1, 2, 4, 8, 16, 32)
        /// </summary>
        /// <value>Sets the level of device memory spoofing. Values can be &#39;automatic&#39;, &#39;manual&#39;, &#39;off&#39;.  When value is set to manual, a specific amount of device memory must be provided (valid values: 0.25, 0.5, 1, 2, 4, 8, 16, 32)</value>
