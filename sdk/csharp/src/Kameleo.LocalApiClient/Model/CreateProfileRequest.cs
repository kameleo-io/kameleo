...
namespace Kameleo.LocalApiClient.Model
{
    ...
    public partial class CreateProfileRequest : IValidatableObject
    {
        ...
        /// <param name="deviceMemory">Sets how the Device Memory will be spoofed. Values can be &#39;automatic&#39;, &#39;manual&#39;, &#39;off&#39;. When value is set to manual, a numeric value (0.25,  0.5, 1, 2, 4, 8, 16, 32) must be provided..</param>
        /// <param name="language">A language or a comma-separated list of languages for the profile.  ISO 639-1 language and optionally ISO 3166-1 region code..</param>
        ...
        /// </summary>
        /// <value>The unique identifier of the fingerprint. This references the fingerprint which should be used to build the new profile.  If not provided, a fingerprint will be automatically selected using the recommended fingerprint search defaults, see: https://developer.kameleo.io/tutorials/filtering-fingerprints/</value>
        /*
        <example>555b894595b5cd242ead1533218a5ee93dd7c7ebfbff4dccb80fdb112f6cda27</example>
        */
        [DataMember(Name = "fingerprintId", EmitDefaultValue = true)]
        ...
        */
        ...
        /// <summary>
        /// Sets how the Device Memory will be spoofed. Values can be &#39;automatic&#39;, &#39;manual&#39;, &#39;off&#39;. When value is set to manual, a numeric value (0.25,  0.5, 1, 2, 4, 8, 16, 32) must be provided.
        /// </summary>
        /// <value>Sets how the Device Memory will be spoofed. Values can be &#39;automatic&#39;, &#39;manual&#39;, &#39;off&#39;. When value is set to manual, a numeric value (0.25,  0.5, 1, 2, 4, 8, 16, 32) must be provided.</value>
        ...
        /// </summary>
        /// <value>A language or a comma-separated list of languages for the profile.  ISO 639-1 language and optionally ISO 3166-1 region code.</value>
        /*
        <example>en-US,en</example>
        */
