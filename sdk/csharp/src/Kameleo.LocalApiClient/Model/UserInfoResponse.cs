...
namespace Kameleo.LocalApiClient.Model
{
    ...
    public partial class UserInfoResponse : IValidatableObject
    {
        ...
        /// <param name="varVersion">The version of the app. (required).</param>
        ...
        /// <param name="runningProfiles">Current usage and maximum limit of the running profiles. (required).</param>
        /// <param name="profileMinutes">Current usage and maximum limit of profile minutes across the tenant. (required).</param>
        /// <param name="cloudTraffic">Current usage and maximum limit of cloud traffic quota across the tenant. (required).</param>
        public UserInfoResponse(Guid userId = default, string displayName = default, string email = default, bool emailConfirmed = default, DateTime subscriptionEnd = default, string plan = default, List<string> capabilities = default, bool gracePeriod = default, DateTime lastAppLogin = default, string varVersion = default, string workspaceFolder = default, QuotaStatistics localStorage = default, QuotaStatistics cloudStorage = default, bool hasTeamSubscription = default, Guid? teamId = default, string teamRole = default, RunningProfiles runningProfiles = default, ProfileMinutesQuota profileMinutes = default, CloudTrafficQuota cloudTraffic = default)
        {
            this.UserId = userId;
            ...
            if (varVersion == null)
            {
                throw new ArgumentNullException("varVersion is a required property for UserInfoResponse and cannot be null");
            }
            ...
            // to ensure "runningProfiles" is required (not null)
            if (runningProfiles == null)
            {
                throw new ArgumentNullException("runningProfiles is a required property for UserInfoResponse and cannot be null");
            }
            this.RunningProfiles = runningProfiles;
            // to ensure "profileMinutes" is required (not null)
            if (profileMinutes == null)
            {
                throw new ArgumentNullException("profileMinutes is a required property for UserInfoResponse and cannot be null");
            }
            this.ProfileMinutes = profileMinutes;
            // to ensure "cloudTraffic" is required (not null)
            if (cloudTraffic == null)
            {
                throw new ArgumentNullException("cloudTraffic is a required property for UserInfoResponse and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        /// <value>The version of the app.</value>
        /*
        ...
        */
        ...
        /// <summary>
        /// Current usage and maximum limit of the running profiles.
        /// </summary>
        /// <value>Current usage and maximum limit of the running profiles.</value>
        [DataMember(Name = "runningProfiles", IsRequired = true, EmitDefaultValue = true)]
        public RunningProfiles RunningProfiles { get; set; }
        ...
        [DataMember(Name = "profileMinutes", IsRequired = true, EmitDefaultValue = true)]
        public ProfileMinutesQuota ProfileMinutes { get; set; }

        /// <summary>
        /// Current usage and maximum limit of cloud traffic quota across the tenant.
        /// </summary>
        /// <value>Current usage and maximum limit of cloud traffic quota across the tenant.</value>
        [DataMember(Name = "cloudTraffic", IsRequired = true, EmitDefaultValue = true)]
        public CloudTrafficQuota CloudTraffic { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RunningProfiles: ").Append(RunningProfiles).Append("\n");
            sb.Append("  ProfileMinutes: ").Append(ProfileMinutes).Append("\n");
            sb.Append("  CloudTraffic: ").Append(CloudTraffic).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
