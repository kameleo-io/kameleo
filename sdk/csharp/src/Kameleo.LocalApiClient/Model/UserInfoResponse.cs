...
namespace Kameleo.LocalApiClient.Model
{
    ...
    public partial class UserInfoResponse : IValidatableObject
    {
        ...
        /// <param name="cloudTraffic">Current usage and maximum limit of cloud traffic quota across the tenant..</param>
        public UserInfoResponse(Guid userId = default, string displayName = default, string email = default, bool emailConfirmed = default, DateTime subscriptionEnd = default, string plan = default, List<string> capabilities = default, bool gracePeriod = default, DateTime lastAppLogin = default, string workspaceFolder = default, QuotaStatistics localStorage = default, QuotaStatistics cloudStorage = default, bool hasTeamSubscription = default, Guid? teamId = default, string teamRole = default, RunningProfilesStatistics runningUserProfiles = default, RunningProfilesStatistics runningTeamProfiles = default, RunningProfilesStatistics runningTenantProfiles = default, ProfileMinutesQuota profileMinutes = default, CloudTrafficQuota cloudTraffic = default)
        {
            this.UserId = userId;
        ...
        */
        ...
        [DataMember(Name = "cloudTraffic", EmitDefaultValue = true)]
