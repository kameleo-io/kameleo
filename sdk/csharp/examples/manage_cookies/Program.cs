...
await driver.Navigate().GoToUrlAsync("https://www.nytimes.com");
await Task.Delay(5_000);

await driver.Navigate().GoToUrlAsync("https://whoer.net");
await Task.Delay(5_000);

await driver.Navigate().GoToUrlAsync("https://www.youtube.com");
await Task.Delay(5_000);
