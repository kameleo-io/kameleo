...
class ProfileApi:
    ...
    def install_profile_kernel(
        ...
        _param = self._install_profile_kernel_serialize(
            profile_id=profile_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def install_profile_kernel_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def install_profile_kernel_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile")],
        _request_timeout: Union[
            None,
    ...
    def _install_profile_kernel_serialize(
        self,
        profile_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/profiles/{profileId}/kernel-install',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_profiles(
        self,
        lifetime_state: Annotated[Optional[Any], Field(description="The lifetime state of the profiles to return (optional)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param lifetime_state: The lifetime state of the profiles to return (optional)
        :type lifetime_state: ProfileLifetimeState
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _list_profiles_serialize(
        ...
        if lifetime_state is not None:
            ...
            _query_params.append(('lifetimeState', lifetime_state.value))
    ...
    def test_profile_proxy(
        ...
        _param = self._test_profile_proxy_serialize(
            profile_id=profile_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def test_profile_proxy_with_http_info(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def test_profile_proxy_without_preload_content(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile")],
        _request_timeout: Union[
            None,
    ...
    def _test_profile_proxy_serialize(
        self,
        profile_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/profiles/{profileId}/test-proxy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
