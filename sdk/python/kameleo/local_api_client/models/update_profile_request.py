...
class UpdateProfileRequest(BaseModel):
    ...
    device_memory: Optional[DeviceMemoryChoice] = Field(default=None, description="Sets how the Device Memory will be spoofed. Values can be 'automatic', 'manual', 'off'. When value is set to manual, a DeviceMemoryType  must be provided (valid values: 0.25, 0.5, 1, 2, 4, 8)", alias="deviceMemory")
