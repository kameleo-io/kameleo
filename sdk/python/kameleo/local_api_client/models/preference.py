...
class Preference(BaseModel):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Key of the preference")
    value: Optional[Any] = Field(description="Value of the preference. It can a string or a boolean or an integer")
