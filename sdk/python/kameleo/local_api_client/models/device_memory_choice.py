...
class DeviceMemoryChoice(BaseModel):
    """
    DeviceMemoryChoice
    """ # noqa: E501
    value: DeviceMemorySpoofingType = Field(description="Specifies how the deviceMemory will be spoofed. Possible values:  'automatic': Automatically set the values based on the fingerprint.  'manual': Manually set the value in the profile. Valid values: 0.25, 0.5, 1, 2, 4, 8, 16, 32.  'off': Turn off the spoofing, use the original settings.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceMemoryChoice from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceMemoryChoice from a dict"""
        if obj is None:
            return None
