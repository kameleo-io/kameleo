...
class ProfilePreview(BaseModel):
    ...
    device: Device = Field(description="Device information about the profile. This is derived from the fingerprint.")
    os: Os = Field(description="Information about the OS of the profile. This is derived from the fingerprint.")
    browser: Browser = Field(description="Information about the browser of the profile. This is derived from the fingerprint.")
