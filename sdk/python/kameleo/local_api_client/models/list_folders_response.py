...
class ListFoldersResponse(BaseModel):
    ...
    ListFoldersResponse
    """ # noqa: E501
    folders: List[FolderResponse] = Field(description="List of top-level folders, each folder may contain nested folders and cloud profiles.")
    profiles: List[ProfilePreview] = Field(description="List of profiles not associated with any folder. This includes both cloud and local profiles.")
