...
class ProfileResponse(BaseModel):
    ...
    device_memory: DeviceMemoryChoice = Field(description="Sets the level of device memory spoofing. Values can be 'automatic', 'manual', 'off'.  When value is set to manual, a specific amount of device memory must be provided (valid values: 0.25, 0.5, 1, 2, 4, 8)", alias="deviceMemory")
    language: StrictStr = Field(description="Language of the profile as ISO 639-1 language and optionally ISO 3166-1 region code.")
