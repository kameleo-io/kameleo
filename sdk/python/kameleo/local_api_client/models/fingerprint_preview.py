...
class FingerprintPreview(BaseModel):
    ...
    webgl_meta: WebglMeta = Field(description="The GPU details of the fingerprint extracted from WebGL parameters.", alias="webglMeta")
    user_agent: StrictStr = Field(description="The user agent of the fingerprint.", alias="userAgent")
