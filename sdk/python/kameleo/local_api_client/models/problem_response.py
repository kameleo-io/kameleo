...
class ProblemResponse(BaseModel):
    ...
    error_code: ErrorCode = Field(description="A machine-readable error code that identifies the specific error condition. This can be used by clients to programmatically handle different error scenarios.", alias="errorCode")
    ...
    errors: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="The validation errors, if any. The keys are field names and the values are arrays of error messages.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "errorCode", "type", "title", "detail", "instance", "errors"]
