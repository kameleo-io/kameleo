...
class BrowserSettings(BaseModel):
    ...
    """ # noqa: E501
    arguments: Optional[List[StrictStr]] = Field(default=None, description="Command line arguments that can be passed to the browser at startup. This applies to both Chroma and Junglefox browsers.")
