...
class Fingerprint(BaseModel):
    ...
    """ # noqa: E501
    version: StrictStr = Field(description="The version of the fingerprint. As time passes new fingerprint versions will be introduced. It is recommended to use the latest one.")
    id: StrictStr = Field(description="The unique identifier of the fingerprint. You can use this as a reference to create a new profile from this fingerprint.")
    user_agent: StrictStr = Field(description="The user agent of the browser fingerprint.", alias="userAgent")
    device: Device = Field(description="Information about the device of the fingerprint.")
    os: Os = Field(description="Information about the OS of the fingerprint.")
    browser: Browser = Field(description="Information about the browser of the fingerprint.")
    webgl_meta: WebglMeta = Field(description="The GPU details extracted from WebGL parameters.", alias="webglMeta")
    resolution: StrictStr = Field(description="The screen size of the device in pixels.")
    fonts: List[StrictStr] = Field(description="A list of font types included in the profile.")
