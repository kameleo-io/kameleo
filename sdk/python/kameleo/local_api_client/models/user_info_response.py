...
class UserInfoResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userId", "displayName", "email", "emailConfirmed", "subscriptionEnd", "plan", "capabilities", "gracePeriod", "lastAppLogin", "workspaceFolder", "localStorage", "cloudStorage", "hasTeamSubscription", "teamId", "teamRole", "runningUserProfiles", "runningTeamProfiles", "runningTenantProfiles", "profileMinutes"]
