...
class UserInfoResponse(BaseModel):
    ...
    cloud_traffic: Optional[CloudTrafficQuota] = Field(default=None, description="Current usage and maximum limit of cloud traffic quota across the tenant.", alias="cloudTraffic")
    __properties: ClassVar[List[str]] = ["userId", "displayName", "email", "emailConfirmed", "subscriptionEnd", "plan", "capabilities", "gracePeriod", "lastAppLogin", "workspaceFolder", "localStorage", "cloudStorage", "hasTeamSubscription", "teamId", "teamRole", "runningUserProfiles", "runningTeamProfiles", "runningTenantProfiles", "profileMinutes", "cloudTraffic"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cloud_traffic (nullable) is None
        # and model_fields_set contains the field
        if self.cloud_traffic is None and "cloud_traffic" in self.model_fields_set:
            _dict['cloudTraffic'] = None
