...
Kameleo adapts automatically to anti-bot changes, so your browser operations keep looking like ordinary human traffic without daily maintenance. This is the Python SDK for Kameleo's [Local API](https://developer.kameleo.io/reference/api-reference/), giving you programmatic control over browser profiles from your existing Playwright, Puppeteer, or Selenium automation.
...
- **Drop into your existing stack** — connect via Playwright, Puppeteer, or Selenium with no framework rewrite; SDKs also available for [TypeScript/JavaScript](https://www.npmjs.com/package/@kameleo/local-api-client) and [C#](https://www.nuget.org/packages/Kameleo.LocalApiClient)
