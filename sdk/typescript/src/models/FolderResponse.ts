...
export interface FolderResponse {
     ...
     * @memberof FolderResponse
     */
    profiles: Array<ProfilePreview>;
    /**
     * List of users accessing this folder.
     * @type {Array<ShareAccess>}
     * @memberof FolderResponse
     */
    shareAccesses: Array<ShareAccess>;
}
...
export function FolderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FolderResponse {
    ...
    return {
        ...
        profiles: (json["profiles"] as Array<any>).map(ProfilePreviewFromJSON),
        shareAccesses: (json["shareAccesses"] as Array<any>).map(ShareAccessFromJSON),
    };
}
...
export function FolderResponseToJSONTyped(value?: FolderResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        profiles: (value["profiles"] as Array<any>).map(ProfilePreviewToJSON),
        shareAccesses: (value["shareAccesses"] as Array<any>).map(ShareAccessToJSON),
    };
}
