...
import type { RunningProfiles } from "./RunningProfiles";
import {
    RunningProfilesFromJSON,
    RunningProfilesFromJSONTyped,
    RunningProfilesToJSON,
    RunningProfilesToJSONTyped,
} from "./RunningProfiles";
...
import type { CloudTrafficQuota } from "./CloudTrafficQuota";
import {
    CloudTrafficQuotaFromJSON,
    CloudTrafficQuotaFromJSONTyped,
    CloudTrafficQuotaToJSON,
    CloudTrafficQuotaToJSONTyped,
} from "./CloudTrafficQuota";
...
export interface UserInfoResponse {
     ...
     * @memberof UserInfoResponse
     */
    profileMinutes: ProfileMinutesQuota;
    /**
     * Current usage and maximum limit of cloud traffic quota across the tenant.
     * @type {CloudTrafficQuota}
     * @memberof UserInfoResponse
     */
    cloudTraffic: CloudTrafficQuota;
}
...
export function instanceOfUserInfoResponse(value: object): value is UserInfoResponse {
    ...
    if (!("runningProfiles" in value) || value["runningProfiles"] === undefined) return false;
    if (!("profileMinutes" in value) || value["profileMinutes"] === undefined) return false;
    if (!("cloudTraffic" in value) || value["cloudTraffic"] === undefined) return false;
    return true;
}
...
export function UserInfoResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserInfoResponse {
    ...
    return {
        ...
        teamRole: json["teamRole"] == null ? undefined : json["teamRole"],
        runningProfiles: RunningProfilesFromJSON(json["runningProfiles"]),
        profileMinutes: ProfileMinutesQuotaFromJSON(json["profileMinutes"]),
        cloudTraffic: CloudTrafficQuotaFromJSON(json["cloudTraffic"]),
    };
}
...
export function UserInfoResponseToJSONTyped(value?: UserInfoResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        runningProfiles: RunningProfilesToJSON(value["runningProfiles"]),
        profileMinutes: ProfileMinutesQuotaToJSON(value["profileMinutes"]),
        cloudTraffic: CloudTrafficQuotaToJSON(value["cloudTraffic"]),
    };
}
