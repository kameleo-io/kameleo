...
export function DeleteFolderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteFolderResponse {
    ...
    return {
        deletedFolders: json["deletedFolders"],
        deletedProfiles: json["deletedProfiles"],
        movedProfiles: (json["movedProfiles"] as Array<any>).map(ProfilePreviewFromJSON),
    };
}
...
export function DeleteFolderResponseToJSONTyped(value?: DeleteFolderResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        movedProfiles: (value["movedProfiles"] as Array<any>).map(ProfilePreviewToJSON),
    };
}
