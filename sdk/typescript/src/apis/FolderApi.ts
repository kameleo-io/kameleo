...
export class FolderApi extends runtime.BaseAPI {
    ...
    async removeProfileFromFolderRaw(
        ...
        let urlPath = `/folders/{guid}/{profileId}`;
        urlPath = urlPath.replace(`{${"guid"}}`, encodeURIComponent(String(requestParameters["guid"])));
    ...
    async shareGroupRaw(
        ...
        let urlPath = `/folders/{guid}/share`;
        urlPath = urlPath.replace(`{${"guid"}}`, encodeURIComponent(String(requestParameters["guid"])));
