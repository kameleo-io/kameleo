...
export interface InstallProfileKernelRequest {
    profileId: string;
}
...
export interface TestProfileProxyRequest {
    profileId: string;
}
...
export class ProfileApi extends runtime.BaseAPI {
    ...
    async deleteProfileRaw(
        ...
        let urlPath = `/profiles/{profileId}`;
    ...
    async duplicateProfileRaw(
        ...
        let urlPath = `/profiles/{profileId}/duplicate`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
    ...
    async exportProfileRaw(
        ...
        let urlPath = `/profiles/{profileId}/export`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
    ...
    async getProfileStatusRaw(
        ...
        let urlPath = `/profiles/{profileId}/status`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
     ...
     */
    async installProfileKernelRaw(
        requestParameters: InstallProfileKernelRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<KernelResponse>> {
        if (requestParameters["profileId"] == null) {
            throw new runtime.RequiredError(
                "profileId",
                'Required parameter "profileId" was null or undefined when calling installProfileKernel().',
            );
        }
        ...
        let urlPath = `/profiles/{profileId}/kernel-install`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
     ...
     * Installs the kernel that best suits the specified profile\'s fingerprint, downloading it if it\'s not already available locally.
     */
    async installProfileKernel(profileId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KernelResponse> {
        const response = await this.installProfileKernelRaw({ profileId: profileId }, initOverrides);
        return await response.value();
    }
    ...
    async listProfilesRaw(
        requestParameters: ListProfilesRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<Array<ProfilePreview>>> {
        const queryParameters: any = {};

        if (requestParameters["lifetimeState"] != null) {
            queryParameters["lifetimeState"] = requestParameters["lifetimeState"];
        }
    ...
    async listProfiles(
        lifetimeState?: ProfileLifetimeState,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<Array<ProfilePreview>> {
        const response = await this.listProfilesRaw({ lifetimeState: lifetimeState }, initOverrides);
        return await response.value();
    }
    ...
    async startProfileRaw(
        ...
        let urlPath = `/profiles/{profileId}/start`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
    ...
    async stopProfileRaw(
        ...
        let urlPath = `/profiles/{profileId}/stop`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
     ...
     */
    async testProfileProxyRaw(
        requestParameters: TestProfileProxyRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<TestProxyResponse>> {
        if (requestParameters["profileId"] == null) {
            throw new runtime.RequiredError(
                "profileId",
                'Required parameter "profileId" was null or undefined when calling testProfileProxy().',
            );
        }
        ...
        let urlPath = `/profiles/{profileId}/test-proxy`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
     ...
     * Tests the proxy connection configured on the given profile and returns every individual test step together with an overall summary. The  summary is \'success\' when every step passes, \'partial_success\' when the website could be reached through at least one of IPv4, IPv6 or DNS  name and the IP location lookup also succeeded, otherwise \'failure\'.
     */
    async testProfileProxy(profileId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TestProxyResponse> {
        const response = await this.testProfileProxyRaw({ profileId: profileId }, initOverrides);
        return await response.value();
    }
    ...
    async upgradeProfileKernelRaw(
        ...
        let urlPath = `/profiles/{profileId}/upgrade`;
        urlPath = urlPath.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters["profileId"])));
