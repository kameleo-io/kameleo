...
export class BaseAPI {
    ...
    protected async request(context: RequestOpts, initOverrides?: RequestInit | InitOverrideFunction): Promise<Response> {
        ...
        try {
            if (response && this.isJsonMime(response.headers.get("content-type"))) {
        ...
        throw new ResponseError(
            response,
            problem?.errorCode != null ? String(problem.errorCode) : "Response returned an error code",
            problem,
        );
    }
    ...
    private async createFetchParams(context: RequestOpts, initOverrides?: RequestInit | InitOverrideFunction) {
        ...
        headers["User-Agent"] = `KameleoLocalApiClient/5.1.0 node/${nodeVersion}`;
...
export class ResponseError extends Error {
    ...
    constructor(
        ...
        this.errorCode = problem?.errorCode as ErrorCode | undefined;
...
export type HTTPQuery = {
    [key: string]:
        string | number | null | boolean | Array<string | number | null | boolean> | Set<string | number | null | boolean> | HTTPQuery;
};
